...
val danmuList = listOf(
    Danmu(text = "壬戌之秋，七月既望，苏子与客泛舟游于赤壁之下。", color = "#FFD700", time = 1),
    Danmu(text = "清风徐来，水波不兴。", color = "#FF6347", time = 4),
    Danmu(text = "举酒属客，诵明月之诗，歌窈窕之章。", color = "#32CD32", time = 7),
    Danmu(text = "少焉，月出于东山之上，徘徊于斗牛之间。", color = "#1E90FF", time = 11),
    Danmu(text = "白露横江，水光接天。", color = "#BA55D3", time = 14),
    Danmu(text = "纵一苇之所如，凌万顷之茫然。", color = "#FF4500", time = 17),
    Danmu(
        text = "浩浩乎如冯虚御风，而不知其所止；飘飘乎如遗世独立，羽化而登仙。",
        color = "#00CED1",
        time = 512
    ),
    Danmu(text = "于是饮酒乐甚，扣舷而歌之。", color = "#FFD700", time = 98),
    Danmu(text = "歌曰：“桂棹兮兰桨，击空明兮溯流光。", color = "#FF69B4", time = 230),
